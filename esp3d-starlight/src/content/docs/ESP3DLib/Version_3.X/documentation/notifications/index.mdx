...
Please follow this [link](whatsapp/) for more information on how to setup a WhatsApp notification service
...
### How to send message ?  
Just add following command in your slicer's end script, or manually on your GCODE file:   
