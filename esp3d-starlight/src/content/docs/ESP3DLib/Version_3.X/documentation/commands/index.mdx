...
3 - `json`, `json=YES`, `json=TRUE`, `json=1` are parameters to switch output to json  
...
<AutoSubpagesList directory="ESP3DLib/Version_3.X/documentation/commands" maxDepth={3} />
