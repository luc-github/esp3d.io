...
prev:
  ...
  label: Rotrics TFT
next:
  link: /esp3d-tft/version_1x/hardware/esp32-s3/sunton-43-4827/
  label: Sunton-43-4827
---

* ESP32-S3 based + TFReader + OV2640 + 3.5' TFT (480x320) with Capacitive touch screen
