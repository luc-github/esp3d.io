...
use subprotocol `webui-v3` the port depends on the firmware. Please refer to the firmware documentation
...
use sub protocol `arduino`  the port depends on the firmware. Please refer to the firmware documentation
...
This mode is used to transfer files to/from the ESP board. **(not implemented yet)**
