...
1 - Install current nodejs LTS (tested with v24.14.0)
...
:::tip[Brotli compression]
The build toolchain supports **Brotli compression**, producing more efficient packages that reduce the size of web assets delivered to the pendant.
:::
