...
-   Terminal commands
-   Emmergency stop
-   Extensions support with manifest and automatic scan
-   Themes support (CSS and JSON bundle)
-   Language packs support with RTL and custom fonts
-   Macro commands
...
-   Dashboard fixed panel order with drag & drop
-   Configuration wizard (TBD)
-   Firmware supported (3DPrinter / CNC / SandTable):
    -   [ESP3D V3.x](/esp3d/version-3x/):
        -   Marlin (1.x / 2.x)
        -   Smoothieware (1.x / 2.x)
        -   Repetier (1.x / 2.x)
        -   GRBL (1.1h)
    -   [ESP3D-TFT V1.X](/esp3d-tft/version_1x/)
    -   [ESP3DLib V3.X](/esp3dlib/version_3x/)
