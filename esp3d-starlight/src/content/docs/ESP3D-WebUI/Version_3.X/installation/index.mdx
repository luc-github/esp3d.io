...
The Web UI is represented by one file: index.html.gz   
...
The default language is english, additional language pack can be added later independantly.
...
#### Using Web UI
* You can upload files using the Web UI file panel

![image](spiffs_access.png)

![image](spiffs_modal.png)

* You can also directly update index.html.gz using the Web UI update button
