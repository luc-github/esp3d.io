...
The ready to use package is available in dist directory [here](https://github.com/luc-github/ESP3D-WEBUI/raw/refs/heads/3.0/extensions/gcodeViewer/dist/esp3dext-gcodeViewer.html)
...
<aside class="info-panel">
  ...
  The ready to use package includes an embedded manifest and is named `esp3dext-gcodeViewer.html`. Upload it as is to the ESP3D-WebUI filesystem (e.g. in `/extensions/`).
