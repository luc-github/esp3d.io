...
* Copy the content of the [libraries directory](https://github.com/luc-github/ESP3D/tree/3.1/libraries) and [extra libraries directory](https://github.com/luc-github/ESP3D/tree/3.1/extra-libraries) (according your target [ESP8266](https://github.com/luc-github/ESP3D/tree/3.1/extra-libraries/ESP8266) or [ESP32](https://github.com/luc-github/ESP3D/tree/3.1/extra-libraries/ESP32) ) to your arduino library directory
...
<img src="/img/installation/arduinoIde.png" alt="Arduino IDE screenshot" class="img-medium" />
