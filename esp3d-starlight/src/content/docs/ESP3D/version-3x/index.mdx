---
title : ESP3D Version 3.X
description : ESP3D firmware version 3.X overview
---

<div class="badges">
  [![badge](https://img.shields.io/badge/ESP3D-3.1.0-red?style=flat-square&logo=github)](https://github.com/luc-github/ESP3D/tree/3.1)
  [![badge](https://img.shields.io/github/commit-activity/y/luc-github/ESP3D/3.1?style=flat-square)](https://github.com/luc-github/ESP3D/tree/3.1)
  [![badge](https://img.shields.io/github/last-commit/luc-github/ESP3D/3.1?style=flat-square)](https://github.com/luc-github/ESP3D/tree/3.1)
...
The firmware must be used with [ESP3D-WEBUI 3.X](/esp3d-webui/version_3x/)
