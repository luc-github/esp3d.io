...
Please follow this [link](email_and_smtp/) for more information on how to setup a email notification service

### [IFTTT webhook](https://ifttt.com)   
A free service up to 5 applets

Please follow this [link](ifttt/) for more information on how to setup a pushover iftt service   
