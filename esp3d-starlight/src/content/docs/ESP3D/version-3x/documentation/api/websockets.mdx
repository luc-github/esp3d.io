...
<table class="table-compact">
  ...
  <tbody>
    <tr>
      <td>Opcode MSB</td>
      <td>Opcode LSB</td>
      <td>Payload length (uint16_t LE)</td>
      <td>Payload</td>
    </tr>
  </tbody>
</table>
...
<tbody>
<tr><td>`S`</td><td>`R`</td><td>0x00</td><td>0x00</td></tr>
</tbody>
</table>
</div>
**ESP → Client**:
...
<table class="table-line">
<tbody>
<tr><td>R</td><td>S</td><td>0x02</td><td>0x00</td><td>O</td><td>1</td></tr>
</tbody>
</table>
</div>
...
<table class="table-line">
<tbody>
<tr><td>`R`</td><td>`S`</td><td>PL_LO</td><td>PL_HI</td><td>`E`</td><td>ERR_CODE</td><td>STR_LEN</td><td>STR...</td></tr>
</tbody>
</table>
</div>
**Upload in progress:**
...
<table class="table-line">
<tbody>
<tr><td>`R`</td><td>`S`</td><td>PL_LO</td><td>PL_HI</td><td>`U`</td><td>PATH_SZ</td><td>PATH...</td><td>NAME_SZ</td><td>NAME...</td><td>TOTAL(4)</td><td>DONE(4)</td><td>LAST_ID(4)</td></tr>
</tbody>
</table>
</div>
...
<table class="table-line">
<tbody>
<tr><td>`R`</td><td>`S`</td><td>PL_LO</td><td>PL_HI</td><td>`D`</td><td>PATH_SZ</td><td>PATH...</td><td>NAME_SZ</td><td>NAME...</td><td>TOTAL(4)</td><td>DONE(4)</td><td>LAST_ID(4)</td></tr>
</tbody>
</table>
</div>
---
...
<table class="table-line">
<tbody>
<tr><td>`S`</td><td>`U`</td><td>PL_LO</td><td>PL_HI</td><td>PATH_SZ</td><td>PATH...</td><td>NAME_SZ</td><td>NAME...</td><td>FILE_SIZE(4)</td></tr>
</tbody>
</table>
</div>
...
<table class="table-line">
<tbody>
<tr><td>`U`</td><td>`S`</td><td>0x01</td><td>0x00</td><td>`O`</td></tr>
</tbody>
</table>
</div>
...
<table class="table-line">
<tbody>
<tr><td>`U`</td><td>`S`</td><td>0x01</td><td>0x00</td><td>`E`</td></tr>
</tbody>
</table>
</div>
---
...
<table class="table-line">
<tbody>
<tr><td>`U`</td><td>`P`</td><td>PL_LO</td><td>PL_HI</td><td>ID(4)</td><td>DATA...</td></tr>
</tbody>
</table>
</div>
**ESP → Client (ACK):**
...
<table class="table-line">
<tbody>
<tr><td>`P`</td><td>`U`</td><td>0x05</td><td>0x00</td><td>`O`</td><td>ID(4)</td></tr>
</tbody>
</table>
</div>
...
<table class="table-line">
<tbody>
<tr><td>P</td><td>U</td><td>0x05</td><td>0x00</td><td>E</td><td>ID(4)</td></tr>
</tbody>
</table>
</div>
...
<table class="table-line">
<tbody>
<tr><td>`E`</td><td>`U`</td><td>0x00</td><td>0x00</td></tr>
</tbody>
</table>
</div>
**ESP → Client (OK):**
...
<table class="table-line">
<tbody>
<tr><td>`U`</td><td>`E`</td><td>0x01</td><td>0x00</td><td>`O`</td></tr>
</tbody>
</table>
</div>
**ESP → Client (Error):**
...
<table class="table-line">
<tbody>
<tr><td>`U`</td><td>`E`</td><td>0x01</td><td>0x00</td><td>`E`</td></tr>
</tbody>
</table>
</div>
---
...
<table class="table-line">
<tbody>
<tr><td>`S`</td><td>`D`</td><td>PL_LO</td><td>PL_HI</td><td>PATH_SZ</td><td>PATH...</td><td>NAME_SZ</td><td>NAME...</td></tr>
</tbody>
</table>
</div>
**ESP → Client (OK — transfer can start):**
...
<table class="table-line">
<tbody>
<tr><td>`D`</td><td>`S`</td><td>0x05</td><td>0x00</td><td>`O`</td><td>FILE_SIZE(4)</td></tr>
</tbody>
</table>
</div>
**ESP → Client (Error):**
...
<table class="table-line">
<tbody>
<tr><td>`D`</td><td>`S`</td><td>0x01</td><td>0x00</td><td>`E`</td></tr>
</tbody>
</table>
</div>
---
...
<table class="table-line">
<tbody>
<tr><td>`D`</td><td>`P`</td><td>PL_LO</td><td>PL_HI</td><td>ID(4)</td><td>DATA...</td></tr>
</tbody>
</table>
</div>
**Client → ESP (ACK):**
...
<table class="table-line">
<tbody>
<tr><td>`P`</td><td>`D`</td><td>0x05</td><td>0x00</td><td>`O`</td><td>ID(4)</td></tr>
</tbody>
</table>
</div>
---
...
<tbody>
<tr>
<td>`E`</td><td>`D`</td><td>0x00</td><td>0x00</td>
</tr>
</tbody>
</table>
</div>
...
<table class="table-line">
<tbody>
<tr><td>`D`</td><td>`E`</td><td>0x01</td><td>0x00</td><td>`O`</td></tr>
</tbody>
</table>
</div>
---
...
<table class="table-line">
<tbody>
<tr><td>`C`</td><td>`M`</td><td>0x01</td><td>0x00</td><td>CMD</td></tr>
</tbody>
</table>
</div>
Command codes:
...
<table class="table-line">
<tbody>
<tr><td>`C`</td><td>`M`</td><td>0x01</td><td>0x00</td><td>`A`</td></tr>
</tbody>
</table>
</div>
---
...
Testing tools are located in the [`tools/websocket`](https://github.com/luc-github/ESP3D/tree/3.1/tools/websocket) directory of the ESP3D repository.
