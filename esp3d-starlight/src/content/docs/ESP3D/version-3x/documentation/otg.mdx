...
<aside class="info-panel">
  <p><strong>Note:</strong></p>
    ...
    Note: the 3D printer/CNC USB port may not provide enough current to power the ESP board. So you may need to add an external power supply to the ESP3D board.
</aside>
<aside class="info-panel">
  <p><strong>Note:</strong></p>
