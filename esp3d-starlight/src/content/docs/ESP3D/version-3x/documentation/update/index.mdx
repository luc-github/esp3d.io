...
import updateIniText from './esp3dcnf.ini?raw';
...
![image](/img/documentation/update/embedded.png)
...
You can update/manage flash file system content and update firmware.  
![image](/img/documentation/update/webui-update.png)
...
<pre><code className="language-ini">{updateIniText}</code></pre>
