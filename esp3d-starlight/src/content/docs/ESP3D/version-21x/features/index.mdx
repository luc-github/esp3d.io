...
* Captive portal in Access point mode which redirect all unknown call to main page
* mDNS, this feature is a discovery protocol, it requires Bonjour installed on the computer. It is supported out of the box by macOS; on Windows and Linux, it needs to be installed
...
* Notifications using WhatsApp / Pushover / Email
* DHT sensor support
