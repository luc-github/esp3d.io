---
title: ESP3D 2.1.X configuration guide
description: ESP3D 2.1.X configuration guide
---

Open `esp3d/config.h` and set the features you want.
...
//Do we use async webserver or not (currently deprecated do not enable it yet)
...
//CAPTIVE_PORTAL_FEATURE: In SoftAP redirect all unknown call to main page
...
//Pins Definition ////////////////////////////////////////////////////////////////////////
//-1 means use default pins of your board whatever the serial you choose
#define ESP_RX_PIN -1
#define ESP_TX_PIN -1
