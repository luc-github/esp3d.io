    ...
    starlight({
      ...
      sidebar: [
                  ...
                  items: [
                    ...
                    { label: 'Authentication', link: '/esp3dlib/version_3x/documentation/authentication/' },
                    {
                      ...
                      items: [
                        ...
                        { label: 'WhatsApp', link: '/esp3dlib/version_3x/documentation/notifications/whatsapp/' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { label: 'What Is ESP3D-X?', link: '/esp3d-x/' },
            {
              label: 'Version 2.X',
              collapsed: true,
              items: [
                ...
                { label: 'Features', link: '/esp3d-x/version_2x/features/' },
                {
                  ...
                  collapsed: true,
                  items: [
                    { label: 'Overview', link: '/esp3d-x/version_2x/hardware/' },
                    { label: 'PiBot Pendant V1', link: '/esp3d-x/version_2x/hardware/pibot-pendant-v1/' },
                  ],
                },
                { label: 'Installation', link: '/esp3d-x/version_2x/installation/' },
                { label: 'User Guide', link: '/esp3d-x/version_2x/user-guide/' },
                { label: 'Showcase', link: '/esp3d-x/version_2x/showcase/' },
                {
                  label: 'Documentation',
                  collapsed: true,
                  items: [
                    ...
                    { label: 'FAQ', link: '/esp3d-x/version_2x/documentation/faq/' },
                    {
                      ...
                      collapsed: true,
                      items: [
                        { label: 'Overview', link: '/esp3d-x/version_2x/documentation/api/' },
                        { label: 'Conventions', link: '/esp3d-x/version_2x/documentation/api/conventions/' },
                        { label: 'Variables', link: '/esp3d-x/version_2x/documentation/api/variables/' },
                        { label: 'Web Handlers', link: '/esp3d-x/version_2x/documentation/api/webhandlers/' },
                        { label: 'WebSockets', link: '/esp3d-x/version_2x/documentation/api/websockets/' },
                        { label: 'WebDAV Service', link: '/esp3d-x/version_2x/documentation/api/webdavservice/' },
                      ],
                    },
                  ],
                },
